...
if __name__ == '__main__':
	...
	param1 = {
		'title': "Neighborhood Analysis: max_p, 1980~2010, 4 variables",
		'filename_suffix': "All",
		'allMetros': True,
	...
	param = {
		...
		'filename_suffix': "LA_kmeans_4years",				 # "Albertville"
		#'filename_suffix': "Albertville",				 # "Albertville"
		#'database': "ltdb",
		#'state_fips': None,
		 'msa_fips': "31080",						 # "10700" LA:31080 SD:41740
		...
		'Sequence': {'seq_clusters': 9, 'dist_type': 'tran'},
		#'Sequence': False,
